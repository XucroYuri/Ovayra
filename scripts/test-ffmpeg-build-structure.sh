...
for requirement in '"scripts/**"' 'target/ffmpeg-a-stage/**' 'target/ffmpeg-b-stage/**' 'target/ffmpeg-a-cpu-evidence.json' 'target/ffmpeg-b-cpu-evidence.json' 'if-no-files-found: error'; do
