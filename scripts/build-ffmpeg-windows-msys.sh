...
configure=(--prefix="$(cygpath -m "$stage_root")" --toolchain=msvc --target-os=win32 --arch=x86_64 --disable-autodetect --disable-debug --disable-doc --disable-ffplay --disable-network --enable-ffmpeg --enable-ffprobe --enable-libopus --enable-libvpx --enable-version3 --disable-gpl --disable-nonfree --enable-d3d11va --enable-dxva2 --enable-mediafoundation --enable-nvenc --enable-nvdec --extra-cflags="-MD -I$prefix_win/include" --extra-ldflags="-LIBPATH:$prefix_win/lib" --extra-libs="opus.lib vpx.lib")
